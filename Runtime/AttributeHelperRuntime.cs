...
{
    public static class AttributeHelperRuntime
    {
        ...
        public static IEnumerable<MethodInfo> GetAllMethods(Type type, string name)
        {
            return GetAllMethods(type, info => info.Name.Equals(name, StringComparison.Ordinal));
        }

        public static IEnumerable<FieldInfo> GetAllFields(Type type, string name)
        {
            return GetAllFields(type, info => info.Name.Equals(name, StringComparison.Ordinal));
        }

        public static IEnumerable<PropertyInfo> GetAllProperties(Type type, string name)
        {
            return GetAllProperties(type, info => info.Name.Equals(name, StringComparison.Ordinal));
        }

        public static IEnumerable<MethodInfo> GetAllMethods(Type type, Func<MethodInfo, bool> predicate = null)
        {
            if (type == null)
            {
                yield break;
        ...
        public static IEnumerable<FieldInfo> GetAllFields(Type type, Func<FieldInfo, bool> predicate = null)
        {
            if (type == null)
            {
                yield break;
        ...
        public static IEnumerable<PropertyInfo> GetAllProperties(Type type, Func<PropertyInfo, bool> predicate = null)
        {
            if (type == null)
            {
                yield break;
