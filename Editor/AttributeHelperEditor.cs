...
{
    public static class AttributeHelperEditor
    {
        /// <summary>
        ...
        {
            return AttributeHelperRuntime.GetValue(GetTargetObjectWithProperty(property), valueName);
        }
        ...
        {
            return AttributeHelperRuntime.SetValue(GetTargetObjectWithProperty(property), valueName, value);
        }
